...
let initWebRouters = (app) => {
    ...
    router.get("/api/get-schedule-doctor-by-date", doctorController.getSheduleDoctorByDate);
     router.get("/api/get-extra-doctor-by-id", doctorController.getExtraDoctorById);
